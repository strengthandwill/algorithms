 ...
 * 
 */
public class SymbolDigraph<Item> extends Digraph implements SymbolGraphAPI<Item> {

	public static void main(String[] args) {
		String[] keys = {"ATL", "DEN", "DFW", "HOU", "JFK", "LAS", "LAX", "MCO", "ORD", "PHX"};
		SymbolDigraph<String> sg = new SymbolDigraph<String>(keys);
		sg.addEdge("JFK" ,"MCO");
		sg.addEdge("ORD" ,"DEN");
		sg.addEdge("ORD" ,"HOU");
		sg.addEdge("DFW" ,"PHX");
	...
	public SymbolDigraph(Item[] keys) {
		super(keys.length);
